...
public class AntTSPTest {
    ...
    public static void main(String[] args) {
        ...
        AntTSP antTSP = new AntTSP("/Users/davidlee/Downloads/luogu/src/main/java/a280.tsp");
        ...
        System.out.println();
        //对结果进行测试
        checkTour(bestTour);//检查路径合法性
        buildDistMatrix("/Users/davidlee/Downloads/luogu/src/main/java/a280.tsp");
        double bestValue = getTourLength(bestTour); //计算路径总长度
        int[] optTour = getOptTour("/Users/davidlee/Downloads/luogu/src/main/java/a280.opt.tour"); //读取已知的最优解
    ...
    private static void checkTour(int tour[]) {
